	...
	public static void setupGUI(int frameX,int frameY,int [] exits) {
		...
		startB.addActionListener(new ActionListener() {
		    public void actionPerformed(ActionEvent e)  {
						  ...
						  clubGrid.isStarted.countDown(); 
						  clubGrid.isPaused.set(false);
		    }
		   });
			...
			pauseB.addActionListener(new ActionListener() {
		      	public void actionPerformed(ActionEvent e) {
		    		// THIS DOES NOTHING - MUST BE FIXED  
					synchronized(clubGrid.isPaused){
					if (clubGrid.isPaused.get()) {
						// Resume logic
						clubGrid.isPaused.set(false);
						clubGrid.isPaused.notifyAll();
						pauseB.setText("Pause");
						
					} else {
						// Pause logic
						clubGrid.isPaused.set(true);
